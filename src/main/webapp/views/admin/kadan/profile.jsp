...
<rapid:override name="page_content">
    ...
    <div class="portlet box purple">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-reorder"></i>编辑修改卡单
            </div>

        </div>
        <div class="portlet-body form">

            <form action="/admin/kadan/profile" method="post" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio-list col-md-6">
                                    <label class="radio-inline">
                                        <input type="radio" name="productKaDan.product.status" value="1"
                                               <s:if test='#request.ProductKaDan.product.status == 1'>checked</s:if>
                                        >是
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="productKaDan.product.status" value="0"
                                               <s:if test='#request.ProductKaDan.product.status == 0'>checked</s:if>
                                        >否
                                    </label>
                                </div>
                            </div>
